...
def ui_full(launch_kwargs):
    with gr.Blocks() as interface:
        gr.Markdown(
            """
            # Biz4 AI Music Generation
            This is a private demo for Biz4 AI Music Generation,
        ...
        gr.Markdown(
            ...
            **WARNING:** Choosing long durations will take a long time to generate (2min might take ~4-10min).
